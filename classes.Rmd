...
plotHeatmap -m "${coverage_dir}class_heatmap_matrix.mat.gz" -out "${image_dir}class_heatmap.svg" --colorMap Greys --zMax 2 --averageTypeSummaryPlot mean --labelRotation 45 --startLabel "ATG" --endLabel "stop" --regionsLabel "class I genes" "class II genes" "class III genes" "class IV genes" --samplesLabel "wt" "rnjA KO" --whatToShow "heatmap and colorbar"

plotProfile -m "${coverage_dir}class_heatmap_matrix.mat.gz" -out "${image_dir}class_profile.svg" --averageType mean --labelRotation 45 --startLabel "ATG" --endLabel "stop" --regionsLabel "class I" "class II" "class III" "class IV" --samplesLabel "wt" "rnjA KO" --yAxisLabel "RNAP occupancy" --plotTitle "average gene profiles"
```
